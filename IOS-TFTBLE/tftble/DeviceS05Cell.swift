...
//    }
    ...
    func initLayoutPositionWithResetPwd(){
        ...
        self.resetPwdLabel.frame = CGRect(x: 8, y: 368, width: descWidth, height: 30)
        self.resetPwdBtn.frame = CGRect(x: contentX, y: 378, width: 80, height: 24)
    ...
    func snpLayoutSubview(){
        ...
        self.rootView.addSubview(relayLabel)
        self.rootView.addSubview(relayContentLabel)
    ...
    static let identifier = "DeviceS05Cell"
    static func dequeueReusable(with tableView:UITableView) -> DeviceS05Cell {
        let reusableCell = tableView.dequeueReusableCell(withIdentifier: DeviceS05Cell.identifier)
        if  let cell = reusableCell as? DeviceS05Cell {
            return cell
        }else{
            return DeviceS05Cell.init(style: .default, reuseIdentifier: DeviceS05Cell.identifier)
        }
    }
}
