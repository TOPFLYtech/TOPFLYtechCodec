...
import Foundation
import UIKit
class HistoryS04Header:UITableViewHeaderFooterView{
    ...
    override init(reuseIdentifier: String?) {
        ...
        labelX += 80
        self.alarmLabel.frame = CGRect(x: labelX, y: labelY, width: 80, height: height)
        labelX += 80
        ...
        self.propLabel.text = NSLocalizedString("door1", comment: "Door")
