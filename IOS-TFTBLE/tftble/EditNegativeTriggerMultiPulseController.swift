//
//  EditNegativeTriggerMultiPulseController.swift
//  tftble
//
...
import CLXToast
import QMUIKit
class EditNegativeTriggerMultiPulseController : UIViewController,UITextFieldDelegate {
    ...
    var delegate : EditNegativeTriggerMultiPulseDelegate?
    @objc private func submit(){
        ...
        self.delegate?.setNegativeTriggerMultiPulseValue(port: port, startLevel: startLevelInt, highLevelPulseWidthTime: highLevelPulseWidthTimeInt  / 100, lowLevelPulseWidthTime: lowLevelPulseWidthTimeInt / 100, pulseCount: pulseCountInt)
