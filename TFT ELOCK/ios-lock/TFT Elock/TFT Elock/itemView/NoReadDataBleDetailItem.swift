...
import Foundation
import UIKit
class NoReadDataBleDetailItem:  UITableViewCell {
   ...
   static let identifier = "NoReadDataBleDetailItem"
   static func dequeueReusable(with tableView:UITableView) -> NoReadDataBleDetailItem {
       let reusableCell = tableView.dequeueReusableCell(withIdentifier: NoReadDataBleDetailItem.identifier)
       if  let cell = reusableCell as? NoReadDataBleDetailItem {
           return cell
       }else{
           return NoReadDataBleDetailItem.init(style: .default, reuseIdentifier: NoReadDataBleDetailItem.identifier)
       }
   }
}
