...
//    }
    ...
    private String satelliteNumberStr;
    private String batteryChargeStr;
    private String networkSignalStr;
    private String originalAlarmCodeStr;
    ...
    public String getSatelliteNumberStr() {
        return satelliteNumberStr;
    }

    public void setSatelliteNumberStr(String satelliteNumberStr) {
        this.satelliteNumberStr = satelliteNumberStr;
    }

    public String getBatteryChargeStr() {
        return batteryChargeStr;
    }

    public void setBatteryChargeStr(String batteryChargeStr) {
        this.batteryChargeStr = batteryChargeStr;
    }

    public String getNetworkSignalStr() {
        return networkSignalStr;
    }

    public void setNetworkSignalStr(String networkSignalStr) {
        this.networkSignalStr = networkSignalStr;
    }

    public String getOriginalAlarmCodeStr() {
        return originalAlarmCodeStr;
    }

    public void setOriginalAlarmCodeStr(String originalAlarmCodeStr) {
        this.originalAlarmCodeStr = originalAlarmCodeStr;
    }
