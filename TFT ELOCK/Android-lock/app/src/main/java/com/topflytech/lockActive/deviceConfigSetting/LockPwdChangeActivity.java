...
public class LockPwdChangeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lock_pwd_change);
        ...
        tvHead.setText(R.string.unlock_pwd);
        ...
        btnConfirm.setOnClickListener(new SingleClickListener() {
            ...
            public void onSingleClick(View view) {
                ...
                if(etOldPwd.getText() == null || etOldPwd.getText().toString().trim().length() != 6 ||
                    ...
                    Toast.makeText(LockPwdChangeActivity.this,R.string.change_pwd_input_error,Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(!newPwd.equals(repeatPwd)){
                    Toast.makeText(LockPwdChangeActivity.this,R.string.repeat_pwd_not_match,Toast.LENGTH_SHORT).show();
                    return;
                }
                Intent intent = new Intent();
                intent.putExtra("newPwd",newPwd);
                intent.putExtra("oldPwd",oldPwd);
                setResult(EditActivity.RESPONSE_CHANGE_UNCLOCK_PWD,intent);
                finish();
            }
        });
    }
