...
//            "Previous Month","Custom"};
    public static int[] itemsStrKey = new int[]{R.string.str_today,R.string.str_yesterday,R.string.str_last_3_day,R.string.str_last_7_day,
                R.string.str_last_week,R.string.str_this_month,R.string.str_pre_month,R.string.str_custom};
