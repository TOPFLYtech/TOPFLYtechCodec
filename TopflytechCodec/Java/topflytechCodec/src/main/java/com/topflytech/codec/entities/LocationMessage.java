...
public class LocationMessage extends Message{
    ...
    private Date date;
    private Long IOP = 0L;
    private Boolean iopIgnition = false;
...
//    protected Integer relaySpeedLimit = 0;
    ...
    private Long remainPowerDistance;
    ...
    public void setLostModeOpen(Boolean lostModeOpen) {
        this.lostModeOpen = lostModeOpen;
    }
    public Boolean getFlashLightOpen() {
        return flashLightOpen;
    }

    public void setFlashLightOpen(Boolean flashLightOpen) {
        this.flashLightOpen = flashLightOpen;
    }

    public Boolean getLogoLightOpen() {
        return logoLightOpen;
    }

    public void setLogoLightOpen(Boolean logoLightOpen) {
        this.logoLightOpen = logoLightOpen;
    }

    public Boolean getBuzzerOpen() {
        return buzzerOpen;
    }
    ...
    public Float getDeviceHighPrecisionTemp() {
        return deviceHighPrecisionTemp;
    }

    public void setDeviceHighPrecisionTemp(Float deviceHighPrecisionTemp) {
        this.deviceHighPrecisionTemp = deviceHighPrecisionTemp;
    }
    ...
    public void setObdElectricData(Boolean obdElectricData) {
        isObdElectricData = obdElectricData;
    }
    ...
    public Long getRemainPowerDistance() {
        return remainPowerDistance;
    }

    public void setRemainPowerDistance(Long remainPowerDistance) {
        this.remainPowerDistance = remainPowerDistance;
    }
