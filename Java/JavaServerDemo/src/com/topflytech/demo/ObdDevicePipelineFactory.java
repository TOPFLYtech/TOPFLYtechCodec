 ...
 */
public class ObdDevicePipelineFactory implements  PipelineFactory {
    private final int availableProcessors;
    private EventExecutorGroup executors;

    public ObdDevicePipelineFactory() {
    ...
    public ChannelInitializer createInitializer() {
        return new ChannelInitializer<SocketChannel>() {
            ...
            protected void initChannel(SocketChannel ch) throws Exception {
                ...
                ObdDecoder decoder = new ObdDecoder();
                ObjectAutowireFactory.autoWireFactory().autowire(decoder);
                pipeline.addLast("decoder", decoder);
                final ObdHandler handler = new ObdHandler();
